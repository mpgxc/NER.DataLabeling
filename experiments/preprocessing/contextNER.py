...
class ContextNER:
    ...
    def __build_sentences(self):
        ...
        return [x for x in self.__df.groupby(self.__groupby).apply(
    ...
    def __parser_arrays(self):
        ...
        self.y_array = np.array([to_categorical(index, num_classes=self.num_tags) for index in y_pad])